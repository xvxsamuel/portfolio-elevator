...
const liftClickAudio = new Audio(liftClickSound);

const buttons = [
  { id: 1, src: button1, x: 29.45, y: 20.8, closesPanel: false, extraSound: null },
  { id: 2, src: button2, x: 67.81, y: 20.8, closesPanel: false, extraSound: null },
  { id: 3, src: button3, x: 29.45, y: 40.95, closesPanel: false, extraSound: null },
  { id: 4, src: button4, x: 67.81, y: 40.95, closesPanel: false, extraSound: null },
  { id: 5, src: button5, x: 29.45, y: 61.1, closesPanel: false, extraSound: null },
  { id: 6, src: button6, x: 67.81, y: 61.1, closesPanel: false, extraSound: meowAudio },
  { id: 7, src: button7, x: 29.45, y: 81.25, closesPanel: false, extraSound: null },
